...
const Contact = () => {
  return (
    <div className='contact-container'>
      ...
      <div className="contact-form flex px-40 py-16">
        <div className="contact-element w-[50%] max-lg:w-[100%]">
          <div className="contact-text">
            <h1 className="text-2xl font-semibold text-[rgb(37,165,222)]">Get in <div className='text-3xl font-semibold'>Touch</div></h1>
            <p className="py-5 w-[80%]">Ortiz is the best theme for elit, sed do eiusmod tempor dolor sit ame tse ctetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et lorna aliquatd minim veniam, quis nostrud exercitation oris nisi</p>
          </div>
        ...
        <div className="contact-element flex flex-col text-black">
          <h1 className="text-xl font-bold">Leave A Message</h1>
          <div className="flex justify-between my-6">
            <input type="text" name="" id="user-name" placeholder='Name' className='border-1 border-gray-300 outline-none py-3 px-4 rounded-3xl' />
            <input type="email" name="" id="user-email" placeholder='Email' className='border-1 border-gray-300 outline-none py-3 px-4 rounded-3xl' />
          </div>
