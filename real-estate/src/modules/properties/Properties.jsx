    ...
    <div>
      ...
      <div className="property-section px-10 py-16">
        <div className="propertyForSale">
          <div class="text-center rounded-lg max-w-[20%] shadow-md">
            ...
            <span class=" text-gray-900 font-medium title-font mb-4">22 First street, Chicago, USA 1200 Sqft, 3 Bed, 2 Bath, 1 Garage</span>
